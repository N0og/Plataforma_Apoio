...
export const Vacinas: React.FC<DefaultProps> = ({ setCurrentPage }) => {
    ...
    useEffect(() => {
        setOrderParam(`http://26.197.116.207:9090/api/v1/reports/VacinasPEC?dbtype=psql&download=true${clientsFilter.filter(item => {
