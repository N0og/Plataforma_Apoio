...
import { useStateController, useDownload, useGetClients, useMountOrder, useAlertMessageEvent, useGetInstallations, useGetUnits, useGetTeams } from '../../hooks';
...
export const Duplicados: React.FC<DefaultProps> = ({ currentPage, setCurrentPage }) => {
