...
import { useGetClients, useStateController, useDownload, useMountOrder, useGetInstallations, useGetTeams, useGetUnits, useAlertMessageEvent } from '../../hooks';
...
export const ProdutividadeUBS: React.FC<DefaultProps> = ({ currentPage, setCurrentPage }) => {
